class PaymentsController < ApplicationController
  ...
  private
    ...
    def payment_params
      params.expect(payment: [ :contact_id, :payable_id, :payable_type, :method, :status, :amount_euro, :amount_dash, :currency, :external_id, :paid_at, :kind, :refund_amount_euro, :refund_due_at, :parent_payment_id, :notes, :meta ])
    end
end
